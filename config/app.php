...
return [
     ...
     */
    'Security' => [
        'salt' => env('SECURITY_SALT', '2c8d2e28845ffada8d14483f8882563cfe99698a2b0fce5e93c5f4e8c3c2010a'),
    ],
    ...
    'EmailTransport' => [
        'default' => [
            ...
            'port' => 465,
            'timeout' => 30,
            'username' => 'GestionnaireAthletesQwerty@gmail.com',
            'password' => 'qazQWERTY987',
            'client' => null,
            'tls' => null,
    ...
    'Datasources' => [
        'default' => [
            ...
            'username' => 'root',
            'password' => 'mysql',
			'database' => ROOT . DS . 'sqlite' . DS . 'EventsSportDb.sqlite',
